      ...
      <nav className="sticky top-0 border py-4 z-50 shadow-md px-4 flex border-red-500 backdrop-saturate-[80%] backdrop-blur-sm bg-white/80 dark:bg-[#121212]/70">
        <div className="border w-full flex items-center justify-between">
          <div className="flex items-center justify-center gap-x-6">
            {
              session ? <button onClick={drawerHandler} className="border flex items-center justify-center">
            ...
            <div className="flex gap-x-6 justify-center border items-center">
              ...
              <Link href={session?"/profile":"/"}>Home</Link>
            </div>
          </div>
              ...
              <div className="border p-2 lg:flex md:flex sm:hidden hidden gap-x-6 items-center rounded-md">
                <div className="flex items-center gap-x-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-[16px] text-[#373B5C] font-semibold">Pankaj</p>
                  </div>
                </div>
                <div className="">
            ...
            >
              ...
              <div className="mt-5 flex flex-col justify-between items-center h-full">
                <ul className="flex flex-col justify-center items-start gap-y-4 w-fit p-2">
                  <li className="flex items-center w-full gap-x-2"><IoIosArrowForward className="text-[#9197B3]" /><Link href="/profile" onClick={handleLinkClick} className="text-[#1A1558] hover:border-[#1A1558] hover:border border transition-colors text-base py-2 px-4 w-full shadow-sm rounded-lg">My Profile</Link></li>
                  <li className="flex items-center w-full gap-x-2"><IoIosArrowForward className="text-[#9197B3]" /><Link href="/myconnections" onClick={handleLinkClick} className="text-[#1A1558] hover:border-[#1A1558] hover:border border transition-colors text-base py-2 px-4 w-full shadow-sm rounded-lg">My Connections</Link></li>
                </ul>
